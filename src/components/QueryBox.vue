        ...
        >
          <template v-slot:activator="{ on: dialog }">
            <v-tooltip bottom>
              ...
              <span>{{ $t('your-previously-enter-commands') }}</span>
            </v-tooltip>
          </template>
          <v-card>
      ...
      >
        ...
        >
          <template v-slot:top>
            <div>
              <pre
                style="font-size: 12pt; color: gray; font-family: monospace; "
                v-html="last_succ_query"
              />
            </div>
          </template>
        </v-data-table>
        ...
        methods: {
            ...
            async fetch_query(cmd) {
                try {
                    ...
                    this.query = '';
                    this.last_succ_query = user_query;
